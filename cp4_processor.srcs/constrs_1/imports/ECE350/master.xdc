...
#set_property -dict {PACKAGE_PIN H4 IOSTANDARD LVCMOS33} [get_ports AUDIO_CLOCK]
...
set_property -dict {PACKAGE_PIN P17 IOSTANDARD LVCMOS33} [get_ports manual_clock]
